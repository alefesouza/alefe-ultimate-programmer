...
public class CompletePlayer2Controller : MonoBehaviour
{
    public GameObject player1;
    public GameObject life, chakra, lifePlayer1, chakraPlayer1;
    ...
    void Start()
    {
        ...
        character = dbHelper.GetPlayer(11);
    ...
    void ChangeSprite()
    {
        spriteHelper.LoadMode(gameObject, spriteMode, transform.position.x, player1.transform.position.x, 2);
    }
    ...
    void FixedUpdate()
    {
        ...
        float moveHorizontal = Input.GetAxis("L_XAxis_2");

        //Store the current vertical input in the float moveVertical.
        float moveVertical = Input.GetAxis("L_YAxis_2");
